...
/*!
    ...
    @param[in] new_buffer new buffer to be set
*/
/**************************************************************************/
void Adafruit_SharpMem::setDisplayBuffer(void* new_buffer){
  free((void*)sharpmem_buffer);
  sharpmem_buffer = (uint8_t*)new_buffer;
}

/**************************************************************************/
/*!
    @brief Gets display buffer
*/
/**************************************************************************/
void* Adafruit_SharpMem::getDisplayBuffer()
{
  return (void*)sharpmem_buffer;
}
...
/**************************************************************************/
/*!
    @brief refreshes spacific line from 0 - 7

    @param line_num number of line to refresh (0 - 7)
*/
/**************************************************************************/
void Adafruit_SharpMem::refresh(uint8_t line_num)
{
  uint8_t bytes_per_line = WIDTH / 8, currentline = ((bytes_per_line*line_num + 1) / (bytes_per_line)) + 1;
  uint8_t line[bytes_per_line + 2];
  ...
  memcpy(line + 1, sharpmem_buffer + (bytes_per_line*line_num), bytes_per_line);
